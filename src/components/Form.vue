      ...
      <v-flex xs12>
        ...
        <v-form enctype="multipart/form-data" @submit.prevent="onSubmit">
          <v-stepper v-model="e1" vertical>
            <v-stepper-step editable color="primary" :complete="e1 > 1" step="1"
              >Info</v-stepper-step
            >
            ...
            <v-stepper-content color="primary" step="1">
              <v-card class="mb-3" flat>
                ...
                <v-card-actions>
                  <v-btn color="primary" dark @click="e1 = 2">Continua</v-btn>
                </v-card-actions>
              </v-card>
            </v-stepper-content>

            <v-stepper-step color="primary" editable :complete="e1 > 2" step="2"
              >Dati Segnalante
            ...
            <v-stepper-content step="2">
                    ...
                    <v-flex v-if="datiSegnalante.anonimo === false" xs12 md6>
                      <v-text-field
                        ...
                        :rules="[
                          ...
                          (v) =>
                            /.+@.+/.test(v) || 'L\'email deve essere valida',
                        ]"
                        label="Email"
                        required
                      ></v-text-field>
                      ...
                      <v-dialog v-model="privacyDialog" width="500">
                        <template v-slot:activator="{ on }">
                          <v-checkbox
                            ...
                            v-model="checkbox"
                            :rules="[
                              (v) => !!v || 'Devi accettare di continuare!',
                            ]"
                            required
                          >
                            <template slot="label">
                              <span
                                >Autorizzo il
                                <a v-on="on">trattamento dei miei dati</a> ai
                                fini della gestione di questa
                                segnalazione.</span
                              >
                            </template>
                          </v-checkbox>
                        ...
                        <v-card>
                          ...
                          <v-card-text>
                            <h3>
                              Whistleblower Informativa sulla Protezione dei
                              Dati Personali
                            </h3>
                            <strong
                            ...
                            >
                            <p>
                              Il Comune di Bitetto prima di acquisire i Suoi
                              dati personali, per finalità di gestione del
                              whistleblowing ai sensi della legge 179/2017, La
                              invita a leggere attentamente l’informativa in
                              tema di protezione dei dati personali.
                            </p>
                            <h4>I. Titolare del Trattamento e DPO</h4>
                            <strong>
                              In questa sezione le indichiamo quali sono i
                              nostri riferimenti
                            </strong>
                            ...
                            <table style="width:100%">
                              <tr>
                                <th>Titolare</th>
                                <td>
                                  Il Comune di Bitetto, con sede legale in
                                  Piazza Aldo Moro 1 - 70020 Bitetto (BA),
                                  rappresentata dal Sindaco pro-tempore, Avv.
                                  Fiorenza Pascazio, è contattabile
                                  all’indirizzo PEC
                            ...
                            <strong>
                              In questa sezione le indichiamo quali tipologie di
                              dati Le chiediamo
                            </strong>
                            ...
                            <table style="width:100%">
                              ...
                              <tr>
                                ...
                                <td>
                                  <strong>Dati Comuni:</strong> dati anagrafici
                                  (nome, cognome, indirizzo, luogo e data di
                                  nascita), identificativi documento identità
                                  (numero patente/C.I./passaporto), dati di
                                  contatto (mail, contatti telefonici).
                                </td>
                              </tr>
                            </table>

                            <p>
                              I predetti dati saranno trattati con supporti
                              informatici e cartacei in modo da garantire idonee
                              misure di sicurezza e riservatezza.
                            </p>

                            <h4>III. Finalità del Trattamento</h4>
                            <strong>
                              In questa sezione le indichiamo lo scopo del
                              trattamento effettuato sui Suoi dati
                            </strong>
                            <table style="width:100%">
                              <tr>
                                <th>Finalità</th>
                              ...
                              <tr>
                                <td>
                                  <em>a)</em> Gestione del procedimento di
                                  whistleblowing
                                </td>
                                <td>
                                ...
                                <td>
                                  <strong>Legale</strong> ai sensi della L.
                                  179/2017
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <em>b)</em> Gestione del procedimento
                                  disciplinare fondato in tutto o in parte sul
                                  whistleblowing
                                </td>
                                <td>
                                ...
                                <td>
                                  <strong>Consenso</strong> ai sensi dell’art.
                                  1, comma 3, L. 179/2017
                                </td>
                              </tr>
                            </table>
                            ...
                            <br />
                            <strong
                              >Dati personali acquisiti direttamente
                              dall’interessato:</strong
                            >
                            <ol>
                              <li>
                                <em>Comuni:</em> dati anagrafici (nome, cognome,
                                indirizzo, data di nascita/morte, cittadinanza,
                                stato civile, professione), codice di
                                identificazione fiscale (di dipendenti e/o
                                cittadini), identificativi documento identità
                                (numero patente/C.I./passaporto), dati di
                                contatto (mail, contatti telefonici), coordinate
                                bancarie, dati economico-finanziari, reddituali,
                                targa veicolo, credenziali, codice
                                identificazione personale (CID).
                              </li>
                              <li>
                                <em>Particolari:</em> dati idonei a rivelare
                                l'appartenenza a partiti, sindacati,
                                associazioni/organizzazioni a carattere
                                religioso o filosofico o origini
                                razziali/etniche, ceppi linguistici, dati idonei
                                a rilevare comportamento, stato di salute, dati
                                comportamentali /psicologici, appartenenza a
                                categorie protette.
                              </li>
                              <li>
                                <em>Giudiziari:</em> dati in materia di
                                casellario giudiziale, di anagrafe delle
                                sanzioni amministrative dipendenti da reato e
                                dei relativi carichi pendenti, o la qualità di
                                imputato o di indagato, liberazione
                                condizionale, divieto/obbligo di soggiorno,
                            ...
                            <ol>
                              <li>
                                Dati relativi alla gestione del rapporto di
                                lavoro, dati multimediali (audio/video), dati di
                                profilazione, dati di valutazione dei
                                dipendenti, provvedimenti disciplinari.
                              </li>
                            </ol>

                            <strong
                              >Dati acquisiti in modo automatico durante la
                              navigazione:</strong
                            >
                            <ol>
                              <li>
                                Indirizzo IP, il tipo di browser utilizzato,
                                l’ISP, il sistema operativo, altri dati forniti
                                in modo automatico durante la navigazione.
                              </li>
                            </ol>

                            <p>
                              Il conferimento dei dati necessari al
                              perseguimento delle finalità sub a) ha natura
                              “obbligatoria” e il Suo eventuale rifiuto
                              comporterà l’impossibilità per il Comune di
                              Bitetto di dar seguito alla segnalazione da Lei
                              avanzata.
                            </p>

                            <p>
                              Il conferimento dei dati necessari al
                              perseguimento delle finalità sub b) ha natura
                              “facoltativa” e il Suo eventuale rifiuto
                              comporterà, ai sensi dell’art. 1, comma 3, L.
                              179/2017, l’inutilizzabilità della segnalazione
                              nell’ambito del procedimento disciplinare,
                              eventualmente avviato, fondato in tutto o in parte
                              sulla segnalazione stessa.
                            </p>

                            <h4>IV. I soggetti destinatari dei dati</h4>
                            <strong
                              >In questa sezione Le indichiamo chi tratterà i
                              Suoi dati e a chi saranno comunicati</strong
                            >

                            <p>
                              Per il perseguimento delle finalità suddette i
                              dati personali potranno essere comunicati ai
                              seguenti soggetti non riconducibili al
                              <em>Comune di Bitetto</em>, ovvero all’Autorità
                              Giudiziaria o ad altre Autorità esterne, secondo
                              le modalità richieste dalla vigente normativa.
                            </p>

                            <h4>V. Conservazione dei dati</h4>
                            <strong
                              >In questa sezione Le indichiamo per quanto tempo
                              conserveremo i Suoi dati</strong
                            >

                            <p>
                              Per tutto il periodo necessario allo svolgimento
                              degli eventuali procedimenti scaturenti dalla
                              gestione della segnalazione (disciplinare, penale,
                              contabile).
                            </p>

                            <h4>VI. Diritti degli Interessati</h4>
                            <strong
                              >In questa sezione Le indichiamo quali diritti Le
                              garantiamo</strong
                            >

                            <p>
                              Il Regolamento UE 679/2016 (artt. da 15 a 23)
                              conferisce agli interessati l’esercizio di
                              specifici diritti. In particolare, in relazione al
                              trattamento dei Suoi dati personali, ha diritto di
                              chiedere al Comune di Bitetto l’accesso, la
                              rettifica, la cancellazione, la limitazione,
                              l’opposizione e la portabilità; inoltre può
                              proporre reclamo, nei confronti dell’Autorità di
                              Controllo, che in Italia è il Garante per la
                              Protezione dei Dati Personali.
                            </p>

                            <p>
                              In qualsiasi momento, potrà chiedere di esercitare
                              i Suoi diritti al Comune di Bitetto, che potrà
                              contattare all’indirizzo mail
                              whistleblowing@comune.bitetto.ba.it ovvero
                              rivolgendosi al Data Protection Officer, che potrà
                              contattare all’indirizzo mail: info@csipa.it
                            </p>
                          </v-card-text>
              ...
              <v-card-actions class="d-flex">
                <v-btn @click="e1 = 1" depressed>Indietro</v-btn>
                <v-spacer></v-spacer>
                <v-btn color="primary" dark @click="validateInfo"
                  >Continua</v-btn
                >
            ...
            <v-stepper-step color="primary" editable :complete="e1 > 3" step="3"
                ...
                <v-container>
                  <v-row>
                    <v-col cols="12">
                      <vue-recaptcha
                        @verify="verify"
                        sitekey="6Ld4yiEpAAAAALVlDZjom-ZJ8MrsjJtgDsK8kDKv"
                      ></vue-recaptcha>
                    </v-col>
                    <v-col cols="12" class="d-flex">
                      <v-btn @click="e1 = 2" depressed>Indietro</v-btn>
                      <v-spacer></v-spacer>
        ...
        .then((response) => {
          if (response.data.id) {
            ...
            EventBus.$emit("snackbar", {
              ...
              state: true,
              text:
                "Si è verificato un errore durante l'invio del modulo. Riprova",
            });
          }
